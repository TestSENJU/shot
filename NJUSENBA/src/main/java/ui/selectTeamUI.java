...
public class selectTeamUI {
	...
	ImageIcon background=new ImageIcon("C://nba/picture/teamBackground1.jpg");
	ImageIcon inquiry=new ImageIcon("C://nba/picture/inquiry.jpg");
	ImageIcon check=new ImageIcon("C://nba/picture/check.jpg");
