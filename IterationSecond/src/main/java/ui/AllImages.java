...
public class AllImages {
	/**       *****************系统初始化背景图片***************       **/
	public static final ImageIcon IMG_BG = new ImageIcon("img/bg2-1.jpg");
	/**       *****************进入系统后背景图片***************       **/
	public static final ImageIcon IMG_BG2 = new ImageIcon("img/bg3-2.jpg");
	/**       *****************系统frame图标***************       **/
	public static final Image IMG_FRAMEICON = new ImageIcon("img/frameIcon.jpg").getImage();
	/**       *****************系统初始化界面欢迎button的图标***************       **/
	public static final ImageIcon IMG_WELCOME = new ImageIcon("img/welcome.jpg");
	/**       *****************返回button图标 100x30***************       **/
	...
	/**       *****************MatchHomePanel winnerTeam button ICON 100x30***************       **/
	public static final ImageIcon IMG_MATCH_WINNERTEAM = new ImageIcon("img/winnerTeam.png");
	/**       *****************MatchHomePanel loserTeam button ICON 100x30***************       **/
