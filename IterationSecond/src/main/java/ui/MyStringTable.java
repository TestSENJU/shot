...
public class MyStringTable extends JTable {
	   ...
	   Object[][] Data = {};
	    ...
	    public MyStringTable( String[][] rowData , String[] columnNames)
	    {
	   ...
	   public MyStringTable( Object[][] rowData , String[] columnNames)
	    {
	    ...
	    public MyStringTable(Object[][] rowData, Object[] columnNames, String[] color) 
	    {
	        super(rowData, columnNames);
	        this.color = color;
	        paintColorRow();
