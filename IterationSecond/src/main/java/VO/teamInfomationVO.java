...
public class teamInfomationVO {
     ...
     public teamInfomationVO(String teamAllName,String teamNameAb,String teamLocation,String teamCluster
    		 ,String teamPartition,String teamHomeCourt,String teamSettingTime,double matchSum,double hitSum, double shootSum,
